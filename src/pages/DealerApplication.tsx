      ...
      <section className="pt-32 pb-16">
        <div className="container mx-auto px-6 text-center">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }}>
            <p className="text-zebra-gold text-xs font-bold uppercase tracking-[0.3em] mb-4">Partner With Us</p>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {benefits.map((b, i) => (
              <motion.div
                ...
                className="p-7 rounded-2xl border border-border/20 bg-section-elevated hover:border-zebra-gold/20 transition-all duration-300"
              >
                <div className="w-11 h-11 rounded-xl bg-zebra-gold/10 flex items-center justify-center mb-4">

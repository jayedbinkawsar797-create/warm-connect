...
const models = [
  {
    ...
    specs: [
      ...
      { icon: Shield, label: "Warranty", value: "10-Year Frame" },
  ...
  },
  {
    ...
    price: "$19,999",
    specs: [
      { icon: Battery, label: "Battery", value: "74V 205Ah Lithium" },
      { icon: Gauge, label: "Top Speed", value: "25 MPH" },
      { icon: Zap, label: "Range", value: "100+ Miles" },
      { icon: Sun, label: "Solar Roof", value: "Integrated" },
      { icon: Shield, label: "Warranty", value: "10-Year Frame" },
            ...
            <table className="w-full min-w-[600px] border-collapse">
              ...
              <tbody>
                {[
                  ...
                  { label: "Battery", values: ["51.2V 230Ah", "51.2V 230Ah", "74V 205Ah"] },
                  { label: "Motor", values: ["5KW AC", "5KW AC", "7.5KW AC"] },
                  { label: "Top Speed", values: ["25 MPH", "25 MPH", "25 MPH"] },
